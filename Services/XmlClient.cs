...
namespace RedhawkApps.Web.Services
{
    ...
    {
        public static IEnumerable<Element> GetAllUniqueElements(string xmlFile)
        {
        ...
        public static List<string> GetAllChangedElements(string xmlFile, string archXmlFile)
        {
        ...
        public static bool CompareXmlChanges(string xmlFile, string changedXmlFile)
        {
        ...
        public static List<string> XmlValidation(string xml, string xsdPath)
        {
